...
export default function SearchBar({ onSearch, onClear }: SearchBarProps) {
  ...
  return (
    <div className="flex items-center gap-2 p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
      <div className="flex-1 relative">
        <input
          type="text"
          placeholder="Search in response bodies..."
          value={keyword}
